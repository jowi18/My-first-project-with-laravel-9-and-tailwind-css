...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    <section>
        ...
        <p class="text-gray-600 pt-2">Sign in your account<a href="/login" class="text-purple-800 font-bold">
            here</a>
         </p>
    ...
    <section class="mt-10">
        ...
        <form action="/store" method="post" class="flex flex-col">
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <input type="text" name="name" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                <label for="password_confimation" class="block text-gray-700 text-sm font-bold mb-2 ml-3">Confirm Password</label>
                <input type="password" name="password_confirmation" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none
                border-b-4 border-gray-400 px-3">
            </div>
            <button class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 rounded shadow-lg 
            hover:shadow-xl transiiton duration-200" type="submit">Sign Up</button>
