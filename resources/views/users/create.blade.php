...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    <section>
        ...
        <p class="text-gray-600 pt-2">Doesn't have an account? Sign Up</p><a href="/register" class="text-purple-800 font-bold">
            here</a>
    </section>
    <section class="mt-10">
        <form action="/login/process" method="POST" class="flex flex-col">
            ...
            hover:shadow-xl transiiton duration-200" type="submit">Login</button>
